...
<div class="row g-4">
    <div class="col-md-10">
        <div class="card h-100 mb-3">
            <h5 class="card-header text-center">Cutting Optimizer</h5>
            <div class="row g-0">
                <div class="card-body">
                    <p class="card-text">
                    Tijdens mijn stage bij Benvitec bekleedde ik de functie van verantwoordelijke voor diverse analyses, waaronder functionele en technische analyses. Om deze uit te voeren, heb ik in eerste instantie overleg gepleegd met relevante belanghebbenden om de behoeften op het bedrijfsniveau te inventariseren. Vervolgens heb ik samengewerkt met verschillende medewerkers die betrokken waren bij de uitvoering van deze taken, zoals het personeel dat verantwoordelijk is voor het opstellen van facturen, waarbij zij deze tool konden gebruiken als indicatie om te bepalen hoeveel platen zij nodig hadden. Ook heb ik overlegd met medewerkers die belast zijn met het snijden van de platen. Tijdens deze gesprekken zijn talloze voorstellen en ideeën naar voren gekomen die van cruciaal belang waren om het project succesvol af te ronden.
                        ...
                        <br/><br/>
                        Vervolgens heb ik mij toegelegd op de ontwikkeling van de applicatie, evenals op het testen van nieuwe functionaliteiten zodra een sprint was voltooid. Uiteraard heb ik deze functionaliteit voorgelegd aan en laten testen door de persoon voor wie deze bestemd was.
                        Na afronding van alle sprints en een grondige test van de applicatie, heb ik een demonstratie van de applicatie gepresenteerd om op die manier aanvullende feedback te verzamelen en mogelijke verbeteringen voor de toekomst te identificeren.
    ...
    <div class="col-md-2">
        <div class="card h-100 mb-3">
            ...
            <div class="row g-0 text-center">
                <a href="https://github.com/Dtc-Xtreme/CuttingOptimizer" target="_blank">
    ...
    <div class="col-12">
        <div class="card h-100 mb-3">
            <h5 class="card-header text-center">Invoer</h5>
            <div class="row g-0">
                <div class="col-12">
                    <div class="card-body">
                        <p class="card-text">   
                ...
                <div class="col-12">
                    <video class="w-100 p-3 m-auto" controls>
                        <source src="/body/images/input.mp4" type="video/mp4">
                    </video>
                </div>
            </div>
        </div>
    ...
    <div class="col-12">
        <div class="card h-100 mb-3">
            <h5 class="card-header text-center">Instellingen: Zaagblad</h5>
            <div class="row g-0">
                <div class="col-12">
                    <div class="card-body">
                        <p class="card-text">   
                ...
                <div class="col-12">
                    <video class="w-100 p-3 m-auto" controls>
                        <source src="/body/images/saw.mp4" type="video/mp4">
                    </video>
                </div>
            </div>
        </div>
    ...
    <div class="col-12">
        <div class="card h-100 mb-3">
            <h5 class="card-header text-center">Instellingen: Fineer</h5>
            <div class="row g-0">
                <div class="col-12">
                    <div class="card-body">
                        <p class="card-text">   
                ...
                <div class="col-12">
                    <video class="w-100 p-3 m-auto" controls>
                        <source src="/body/images/veneer.mp4" type="video/mp4">
                    </video>
                </div>
            </div>
        </div>
    ...
    <div class="col-12">
        <div class="card h-100 mb-3">
            <h5 class="card-header text-center">Ophalen</h5>
            <div class="row g-0">
                <div class="col-12">
                    <div class="card-body">
                        <p class="card-text">   
                ...
                <div class="col-12">
                    <video class="w-100 p-3 m-auto" controls>
                        <source src="/body/images/load.mp4" type="video/mp4">
                    </video>
                </div>
            </div>
        </div>
