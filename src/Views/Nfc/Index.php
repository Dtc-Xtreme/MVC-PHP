...
<div class="row g-4">
    ...
    <div class="col-lg-2 col-md-12">
        <div class="card h-100 mb-3">
            ...
            <div class="row g-0 text-center">
                <a href="https://github.com/Dtc-Xtreme/NFC" target="_blank">
        ...
        <div class="card h-100 mb-3">
            ...
            <div class="row g-0">
                <div class="col-lg-6 col-md-3 col-sm-3">
                    <img src="/body/images/nfc_card.png" class="w-100 p-3 m-auto" alt="...">
                </div>
                <div class="col-lg-2 col-md-2 col-sm-2">
                    <img src="/body/images/nfc_data_types.png" class="w-100 p-3 m-auto" alt="...">
                </div>
    ...
    <div class="col-12">
        <div class="card h-100 mb-3">
            <h5 class="card-header text-center">NFC Libary C#</h5>
            <div class="row g-0">
                <div class="col-lg-7 col-md-3 col-sm-3">
                    <img src="/body/images/nfc_implementation.jpg" class="w-100 p-3 m-auto" alt="...">
                </div>
                <div class="col-lg-5 col-md-9 col-sm-9">
                    <div class="card-body">
                        <p class="card-text">   
                            Er is gebruik gemaakt van een bestaande NFC-library die te vinden is op deze <a href="https://github.com/franckbour/Plugin.NFC" target="_blank">link</a>. Op deze pagina vind je voorbeelden van hoe je het kunt implementeren. <br/><br/>
                            Deze library biedt verschillende functies om het gehele proces te laten werken. Je kunt bijvoorbeeld detecteren wanneer er een kaart in de buurt van het apparaat is, starten of stoppen met het lezen van de kaart, en de gegevens interpreteren en converteren naar het benodigde type. <br/><br/>
            ...
            <div class="row g-0">
                <div class="col-lg-5 col-md-3 col-sm-3">
                    <video class="w-100 p-3 m-auto" controls>
                        <source src="/body/images/nfc.mp4" type="video/mp4">
                    </video>
                </div>
                <div class="col-lg-7 col-md-9 col-sm-9">
                    <div class="card-body">
                        <p class="card-text">   
                            Deze video laat het gebruik van NFC zien. De NFC-tag bevat gegevens zoals naam, voornaam, club en een ID. Via een API wordt de ID gebruikt om actuele gegevens op te halen. Als er geen internetverbinding is, wordt er teruggevallen op de gegevens op de NFC-tag.<br/><br/>
                ...
                <div class="col-12">
                    <div class="card-body">
                        <p class="card-text text-">
                            ...
                            Vervolgens heb ik de NFC-logica geïmplementeerd. Ik heb code geschreven om NFC-apparaten te detecteren, gegevens te lezen en te schrijven naar NFC-tags, en de communicatie tussen de app en het NFC-apparaat af te handelen. <br/><br/>
                            ...
                            Het implementeren van NFC in C# MAUI was een boeiende en leerzame ervaring. Ik moest werken met verschillende technologieën en platforms, wat enige complexiteit met zich meebracht. Het vereiste een diepgaand begrip van NFC-technologie en het C# MAUI-framework. <br/><br/>
